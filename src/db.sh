...
CREATE TABLE IF NOT EXISTS repositories (id INTEGER PRIMARY KEY AUTOINCREMENT, repository TEXT, notebooks TEXT, setups TEXT, requirements TEXT, notebooks_count INTEGER, setups_count INTEGER, requirements_count INTEGER, host_type TEXT, score_env INTEGER, score_data INTEGER, score_docs INTEGER, score_code INTEGER, score_repro INTEGER, score_total INTEGER);
